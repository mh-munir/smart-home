...
const EditProductPage = () => {
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        // Parse description to extract main description and sub-sections
        let mainDescription = data.description || '';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(error);
      alert(error instanceof Error ? error.message : 'Error updating product');
    } finally {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white shadow-2xl rounded-2xl border border-gray-100">
      <h2 className="text-3xl font-extrabold mb-8 text-gray-800 border-b pb-4">✏️ Edit Product</h2>
