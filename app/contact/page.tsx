...
export const metadata = {
  ...
  description:
    `Contact ${SITE_NAME}. Get in touch with our team for questions, feedback, or partnership inquiries.`,
  alternates: {
        ...
        <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              ...
              <form action={`mailto:${SITE_EMAIL}`} method="post" encType="text/plain" className="space-y-6">
                <div>
          ...
          <section className="bg-gray-50 p-8 rounded-lg">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  For advertising inquiries, please reach out to us at {SITE_EMAIL} with details about your product or service.
                </p>
              </div>
              <div>
