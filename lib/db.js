...
// Detect if we're running inside `next build` (static page generation).
// During build, if MongoDB is unreachable we should fail fast rather than
// retrying for 60+ seconds, because all callers already have try/catch
// fallbacks that return empty data.
const isBuildPhase =
