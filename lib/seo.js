export function generateBlog(keyword) {
  return {
    ...
    sections: [
      {
        heading: "Overview",
        content: `Detailed analysis of the top ${keyword} products available in the market. We have tested and reviewed multiple options to bring you the best choices.`,
      },
      {
        heading: "Top Picks",
